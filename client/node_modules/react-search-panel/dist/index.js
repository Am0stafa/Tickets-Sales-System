            ...
            React__default['default'].createElement("div", { className: "\n            " + styles$4.searchContainer + "\n            " + (isExpanded && (choices.length > 0) ? styles$4.searchContainerExpanded : "") + "\n            " + (isExpanded && shadow ? styles$4.searchContainerExpandedShadow : "") + "\n            " + (small ? styles$4.small : "") + "\n            " + (shadow ? styles$4.searchContainerShadow : "") + "\n          " },
                React__default['default'].createElement("div", { className: styles$4.flexContainer },
                    ...
                    React__default['default'].createElement("div", { className: styles$4.inputContainer },
                        ...
                        React__default['default'].createElement("input", { ref: searchField, className: styles$4.inputField + " " + (small ? styles$4.small : ""), type: "text", "aria-autocomplete": "both", "aria-haspopup": "false", autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", role: "combobox", spellCheck: "false", title: placeholder, "aria-label": placeholder, "aria-controls": resultContainerId, "aria-expanded": isExpanded, placeholder: placeholder, onChange: handleSearchChange, onFocus: handleFocusEvent, value: value })),
